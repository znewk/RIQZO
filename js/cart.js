    ...
    <div class="item" style="height: auto; min-height: auto;">
        ...
        <div class="itemContent" style="height: auto; min-height: auto;">
            <div>
                ...
                <div>
                    <span class="itemPrice">${userCart[i]['price']}.00kzt</span> <span class="itemPriceOld">${userCart[i]['price']+40}.00kzt</span>
                </div>
            </div>
            <div class="itemCount">
            ...
            <div style="
                display: flex;
            ">
                <button class="addToCartBtn" style="margin: 10px;">Удалить из корзины</button>
...
function upItemCount(itemName){
    for(i=0;i<userCart.length;i++){
        if(userCart[i]['name'] === itemName){
            userCart[i]['count']++
            userCart[i]['price'] += userCart[i]['price']
